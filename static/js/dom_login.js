let domLogin = {
    createLoginContainer: function(){
        ...
        + '<form id = "login-form" class="form-signin">'
            ...
            + '<div id="remember" class="checkbox">'
               ...
               + '</label>'
            + '</div>'
            + '<button  onClick ="sendToServer.sendLoginData()" class="btn btn-lg btn-primary btn-block btn-signin" type="submit">Sign in</button>'
        + '</form><!-- /form -->'
    ...
    getLoginForm: function(){
        ...
        var password = formContent.elements["inputPassword"].value;
